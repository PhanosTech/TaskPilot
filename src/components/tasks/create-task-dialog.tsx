...
interface CreateTaskDialogProps {
   ...
   * The consumer (DataContext.createTask) will compute storyPoints from subtasks.
   */
...
export function CreateTaskDialog({
  ...
  const onSubmit = (data: TaskFormValues) => {
    ...
    // Ensure description is always a string (Task.description is typed as string)
    // and don't include storyPoints here — the data layer will compute it.
    onTaskCreated({
      ...data,
