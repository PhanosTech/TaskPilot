...
/**
 * Zod schema for validating the create task form.
 */
 ...
 */
interface CreateTaskDialogProps {
  /** Callback function invoked when a task is successfully created. */
  onTaskCreated: (data: Omit<Task, 'id' | 'logs' | 'storyPoints'>) => void;
  /** Optional controlled state for the dialog's visibility. */
  open?: boolean;
  /** Optional callback for when the dialog's open state changes. */
  onOpenChange?: (open: boolean) => void;
  /** The trigger element for the dialog. */
  children?: ReactNode;
  /** The default status for a new task. */
  defaultStatus?: TaskStatus;
  /** The default project ID for a new task. */
  defaultProjectId?: string;
}

/**
 * @component CreateTaskDialog
 * A dialog component for creating a new task. It includes fields for title, description,
 * project, priority, deadline, and a dynamic list of subtasks.
...
export function CreateTaskDialog({ 
  ...
  /**
   * Handles adding a new subtask to the form state.
   */
  ...
  /**
   * Handles the form submission, formats the data, and calls the onTaskCreated callback.
   * @param {TaskFormValues} data - The validated form data.
   */
