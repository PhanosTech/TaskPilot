...
/**
 * @page ProjectsPage
 * Displays a list of all projects, grouped by their status. Allows users to create
 * new projects and toggle the visibility of archived projects.
 * @returns {JSX.Element} The rendered projects list page.
 */
export default function ProjectsPage() {
  ...
  /**
   * Memoized calculation of each project's task count and progress percentage.
   * Progress is calculated based on the story points of completed tasks and subtasks.
   */
  ...
  /**
   * Memoized list of filtered and sorted projects based on the 'showArchived' state.
   */
  ...
  /**
   * Memoized grouping of projects by their status for rendering.
   */
